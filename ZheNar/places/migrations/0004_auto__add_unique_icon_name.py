...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Icon', fields ['name']
        db.create_unique(u'places_icon', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Icon', fields ['name']
        db.delete_unique(u'places_icon', ['name'])
