...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.events_followers'
        db.add_column(u'places_place', 'events_followers',
                      self.gf('django.db.models.fields.BigIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Place.events_followers'
        db.delete_column(u'places_place', 'events_followers')
    ...
    models = {
        ...
        u'places.place': {
            ...
            'events_followers': ('django.db.models.fields.BigIntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
