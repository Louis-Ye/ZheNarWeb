...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.pic_name'
        db.add_column(u'events_event', 'pic_name',
                      self.gf('django.db.models.fields.CharField')(default='event_default', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.pic_name'
        db.delete_column(u'events_event', 'pic_name')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'default': "'Not mentioned'", 'max_length': '255'}),
            ...
            'pic_name': ('django.db.models.fields.CharField', [], {'default': "'event_default'", 'max_length': '255'}),
